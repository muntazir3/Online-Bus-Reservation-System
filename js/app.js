...
(function (window, document, $, undefined) {
 ...
 $(document).ready(function () {
        ...
        $(".next-button").click(function () {
            ...
            const $currentBody = $(".modal-body-step-" + currentStep);
            const $nextBody = $(".modal-body-step-" + (currentStep + 1));

            if (currentStep === 1 && $("#name").val() === "" || $("#email").val() === "") {
                alert("Please fill out all fields.");
                return;
            }
            if (currentStep === 2 && !$("input[name='radio']:checked").val()) {
                alert("Please select an option.");
                return;
            }

            // Update classes for progress
            $currentBody.removeClass("is-showing");
            $nextBody.addClass("is-showing");
        ...
        $("#multi-step-form").submit(function (e) {
            ...
            $(".modal-wrap").addClass("animate-up");
            setTimeout(function () {
        ...
        $(".rerun-button").click(function () {
            ...
            $(".modal-header span").removeClass("is-active").first().addClass("is-active");
            $(this).hide();
        });
    });
